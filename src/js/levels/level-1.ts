...
import enemyFactory from '../helpers/enemy-factory';
import {Enemy} from '../entities/enemy';
import {Point} from '../lib/interfaces';

const SPAWN: Point = {x: 190, y: -30};
const PLACES: Point[] = [
    {x: 475, y: 208},
    {x: 653, y: 208},
    {x: 361, y: 352},
...
class GrassLevel extends Level {
    public constructor() {
        super(SPAWN, PATHS, PLACES, MAP);
        this.health = 5;
        this.money = 150;
    }

    public generateEnemies(onDeath: Function, onFinished: Function): Enemy[] {
